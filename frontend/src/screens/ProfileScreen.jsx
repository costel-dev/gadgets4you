...
const ProfileScreen = ({ history }) => {
  ...
  // Get userDetails from our state
  const userDetails = useSelector((state) => state.userDetails);
  // Destructure our userDetails data
  ...
  // Destructure our userUpdateProfile data
  const { success } = userUpdateProfile;

  // Get myOrdersList from our state
  const myOrdersList = useSelector((state) => state.myOrdersList);
  // Destructure our myOrdersList data
